...
public class ThumbnailProvider(int thumbnailWidth, int thumbnailHeight) : IDisposable
{
    ...
    {
        var scaleWidth = (double)thumbnailWidth / videoSize.width;
        var scaleHeight = (double)thumbnailHeight / videoSize.height;
        var scale = Math.Min(scaleWidth, scaleHeight);

        return ((int)(videoSize.width * scale), (int)(videoSize.height * scale));
    }
